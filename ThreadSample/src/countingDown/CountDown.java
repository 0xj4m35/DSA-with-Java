...
public class CountDown extends javax.swing.JFrame {
    ...
    public class CountThread implements Runnable {
        ...
        public CountThread(int fromN, int toN, int stepN) {
            this.fromN = fromN;
            this.toN = toN;
            this.stepN = stepN;
        }
        ...
        public void run() {
            try {
                ...
                if (fromN > toN) {
                    tt.start();
                    for (int num = fromN; num >= toN; num -= stepN) {
                        jTextField4.setText(num + "");
                        Thread.sleep(1000);
                    }
                    jTextField4.setText(toN + "");
                    jLabel1.setForeground(Color.BLUE);
                    tt.interrupt();
                }
                else if (fromN < toN) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int fromN = Integer.parseInt(jTextField1.getText().trim());
        int toN = Integer.parseInt(jTextField2.getText().trim());
        int stepN = Integer.parseInt(jTextField3.getText().trim());
        
        Thread ct = new Thread(new CountThread(fromN, toN, stepN));
        ct.start();
