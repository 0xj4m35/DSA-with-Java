...
public class ListLending {
    ...
    void loadBook(String xFile) throws IOException {
        bst.loadFile(xFile);
    }
    
    void loadReader(String xFile) throws IOException {
        lr.loadFile(xFile);
    }
    ...
    void lend(String bCode, String rCode) {
        NodeBook nb = bst.searchBCode(bCode);
